...
const PaginationControls = ({ handleClick, currentPage, maxPlayers }: PaginationControlsProps) => {
    return (
        <div className='flex justify-end'>
            ...
            <span className="bg-slate-900 flex justify-center items-center w-80 h-14">{currentPage}/{Math.ceil(maxPlayers / 9)}</span>
            <span
